...
public class Parameters {
    ...
    public static long totalRuntime = 1 * 20000;
    ...
    public static final long timeLimitPerAlgorithmConstant = 25000;
    public static final long timeLimitPerAlgorithmVariable = 3000;
